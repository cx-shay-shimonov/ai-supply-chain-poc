...
echo "╔════════════════════════════════════════════════════════════════╗"
echo "║           🤖 AI Usage Audit - Combined Analysis               ║"
echo "╚════════════════════════════════════════════════════════════════╝"
echo ""
echo "📁 Target: $TARGET"
...
echo "   • semgrep_results.json (raw static analysis output)"
if [ "$SKIP_SEM" = false ] && [ "$SEM_COUNT" -gt 0 ]; then
    echo "   • semantic_ai_providers.json (complete: summary + raw_results + assets)"
    echo "   • semantic_assets.json (assets only)"
fi
if [ "$SEMGREP_COUNT" -gt 0 ]; then
    echo "   • semgrep_ai_providers.json (complete: summary + raw_results + assets + rules)"
    echo "   • semgrep_assets.json (assets only)"
fi
echo ""
